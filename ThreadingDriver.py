...
'''
def page_search(type: str, search_term: str):
    match type.upper():
        case "XPATH":
...
class ThreadingDriver(webdriver.Edge):
    ...
    def choose_combobox_value(self, page_search: Tuple[str,str], allow_empty_value = False, manual_values=None):
        try:
    ...
    '''
    @repeat_until_successful
    def choose_textbox_value(self, page_search: Tuple[str,str], list):
        try:
    ...
    '''
    Presses tab to exit the current element
